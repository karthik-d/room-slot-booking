...
class GenerateEmployeeID(View):
	""" Class based view to generate employee ID after verifying admin password 
	"""
...
class ManageEmployeeID(View):
	"""Class based view to view and unassign employee IDs. Unassigning an
	employee ID deletes the corresponding user. This way the admin has access
	to delete any employee (presently, only a manager)
	"""
